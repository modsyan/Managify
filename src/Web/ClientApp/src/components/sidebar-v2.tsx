...
export default function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={cn(
        "w-[300px] border-2 border-gray-100 bg-white dark:bg-gray-100/50 2xl:w-72 font-cairo min-h-screen max-h-fit ",
                        ...
                        header={({ open, toggle }) => (
                          <div
                            ...
                            className={cn(
                              ...
                              isDropdownOpen
                                ? "before:top-2/5 text-red-dark before:absolute before:-start-3 before:block before:h-4/5 before:w-1 before:rounded-ee-md before:rounded-se-md before:bg-red-dark 2xl:before:-start-5"
                              ...
                              <div className="flex items-center truncate">
                                <span
                                  className={cn(
                                    ...
                                    isChildActive
                                      ? "bg-red-dark ring-[1px] ring-red-dark"
                                      : "opacity-40"
                                  )}
                                />{" "}
